...
Artifacts:
  out/CORE_THETA_QCD_LOCK/theta_qcd_lock_v0_2.json
  out/CORE_THETA_QCD_LOCK/theta_qcd_lock_summary_v0_2.md
...
def main() -> int:
    ...
    out_json = repo / "out/CORE_THETA_QCD_LOCK/theta_qcd_lock_v0_2.json"
    out_md = repo / "out/CORE_THETA_QCD_LOCK/theta_qcd_lock_summary_v0_2.md"
