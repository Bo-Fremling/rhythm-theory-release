...
Outputs:
  out/NU_MECHANISM_LOCK/nu_mechanism_lock_v0_3.json
  out/NU_MECHANISM_LOCK/nu_mechanism_lock_summary_v0_3.md
...
def main() -> int:
    ...
    out_json = repo / f"out/NU_MECHANISM_LOCK/nu_mechanism_lock_{VERSION}.json"
    out_md = repo / f"out/NU_MECHANISM_LOCK/nu_mechanism_lock_summary_{VERSION}.md"
    ...
    for p in patterns_out:
        ...
        lines.append(f"### Pattern {p['id']} n={p['n']} ({p.get('note','')})")
        lines.append("")
